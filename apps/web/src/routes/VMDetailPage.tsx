  ...
  return (
    <div className="space-y-5">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="options"><PlaceholderTab label="VM Options" /></TabsContent>
        <TabsContent value="cloudinit"><PlaceholderTab label="Cloud-Init Configuration" /></TabsContent>
